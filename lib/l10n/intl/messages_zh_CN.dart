...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "applications": MessageLookupByLibrary.simpleMessage("应用"),
    ...
    "couldNotGetIpAddress": MessageLookupByLibrary.simpleMessage("无法获取 IP 地址"),
    ...
    "routeDoctor": MessageLookupByLibrary.simpleMessage("路由诊断"),
    "routeDoctorDesc": MessageLookupByLibrary.simpleMessage(
      "查找配置文件、DNS 或连接不工作的原因",
    ),
