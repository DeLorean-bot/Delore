...
class BuildCommand extends Command {
  ...
  _buildWindowsApp({
    ...
    if (issTemplate.existsSync()) {
      ...
      final innoSetupCandidates = [
        File(r"C:\Program Files (x86)\Inno Setup 6\ISCC.exe"),
        File(join(localAppData, "Programs", "Inno Setup 6", "ISCC.exe")),
      ];
      final innoSetup = innoSetupCandidates
